...
function saveLocations() {
  ...
  jobs[0].dropSite = parseInt(document.getElementById("dropLocation0").value) + 1;
  jobs[0].nextLocationNumber = parseInt(document.getElementById("loadLocation1").value);
  jobs[1].startLocation = parseInt(document.getElementById("dropLocation0").value) + 1;

  jobs[1].loadSite = parseInt(document.getElementById("loadLocation1").value);
  jobs[1].dropSite = parseInt(document.getElementById("dropLocation1").value) + 1;
  jobs[1].nextLocationNumber = parseInt(document.getElementById("loadLocation2").value);

  jobs[2].startLocation = parseInt(document.getElementById("dropLocation1").value) + 1;
  jobs[2].loadSite = parseInt(document.getElementById("loadLocation2").value);
  jobs[2].dropSite = parseInt(document.getElementById("dropLocation2").value) + 1;
  jobs[2].nextLocationNumber = parseInt(document.getElementById("loadLocation3").value);

  jobs[3].startLocation = parseInt(document.getElementById("dropLocation2").value) + 1;
  jobs[3].loadSite = parseInt(document.getElementById("loadLocation3").value);
  jobs[3].dropSite = parseInt(document.getElementById("dropLocation3").value) + 1;
...
function loadDropDistance(trip) {
...
function numberToTerminal(input) {
  if (input = 0) { return "terminal"; }
  else if (input = 1) { return "magellan"; }
  else if (input = 2) { return "motiva"; }
  else if (input = 3) { return "nustar"; }
  else if (input = 4) { return "aledo"; }
  else if (input = 5) { return "caddo"; }
}
...
function makeA() {
  ...
  function addTime(time, add) { return time.getTime() + add; }

  function makeDate(minute) { return new Date(startTime.getTime() + milli(minute)); }
  //-----
  ...
  console.log("Return to terminal" + f.format(agenda.a51) + ':' + f.format(agenda.a54));
